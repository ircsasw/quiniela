...
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      	<h1 class="logo-name text-lg text-center"><img alt="Logo" src="<?= Yii::getAlias('@logo')?>/img/logo-IRCSA_riot.png" width="300" /></h1>
      <ul class="timeline">
        <li>
          ...
          <div class="timeline-panel">
            ...
            <div class="timeline-body">
              <p class="text-muted">
		 Desde hace más de 10 años nos dedicamos al análisis, diseño y desarrollo de aplicaciones web, de escritorio y sitios web para la pequeña y mediana empresa así como a la consultoría, asistencia y capacitación en los recursos informáticos.
              </p>
            </div>
          </div>
          <div class="line"></div>
